...
async function run() {
    try {
        ...
        const reviewCollection = client.db("SwipeDefend").collection("reviews");
        const paymentCollection = client.db("SwipeDefend").collection("payments");
        const contactCollection = client.db("SwipeDefend").collection("contact");
        const scoreHistoryCollection = client.db(`${process.env.DB_USER}`).collection("scoreHistory");
        ...
        app.post('/scoreHistory', async (req, res) => {
...
app.get('/', (req, res) => {
    res.send('SwipeDefend is sitting')
})

app.listen(port, () => {
    console.log(`SwipeDefend is sitting on port ${port}`);
})
