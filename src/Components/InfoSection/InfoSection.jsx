    ...
    return (
        ...
        <div>
            <h1 className=" md:text-left">
                The credit scores provided are based on the <span className="font-bold">VantageScore® 3.0 model</span>. Lenders use a variety of credit scores and are likely to use a credit score different from <span className="font-bold">VantageScore® 3.0</span> to assess your creditworthiness.
